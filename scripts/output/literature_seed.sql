...
INSERT INTO cultural_item (category, title, summary, content, region, tags, status, source) VALUES ('literature', '孟姜女传说', '中国四大民间传说之一，讲述孟姜女哭倒长城的故事。', '孟姜女传说是中国四大民间传说之一。相传秦朝时期，孟姜女的丈夫范喜良被征去修长城，多年未归。孟姜女千里寻夫，得知丈夫已死，悲痛欲绝，哭了三天三夜，竟把长城哭倒了一段。这个传说反映了古代劳动人民对暴政的控诉和对爱情忠贞的赞美。山东泰安、淄博等地都有孟姜女传说的流传版本。', '泰安', '["四大传说", "泰安", "爱情传说"]', 'published', 'ai');
...
INSERT INTO cultural_item (category, title, summary, content, region, tags, status, source) VALUES ('literature', '梁祝传说', '中国四大民间传说之一，讲述梁山伯与祝英台的爱情故事。', '梁祝传说是中国四大民间传说之一。相传东晋时期，祝英台女扮男装外出求学，与梁山伯同窗三年。梁山伯不知祝英台是女子，待得知真相后，祝英台已被许配他人。梁山伯相思成疾而死，祝英台出嫁途中祭拜梁山伯墓，墓裂而入，双双化蝶。山东济宁等地有梁祝传说的流传版本。', '济宁', '["四大传说", "济宁", "爱情传说"]', 'published', 'ai');
...
INSERT INTO cultural_item (category, title, summary, content, region, tags, status, source) VALUES ('literature', '泰山传说', '关于泰山的神话传说，包括泰山老奶奶、碧霞元君等。', '泰山传说是关于泰山的神话传说。泰山被誉为五岳之首，自古就是帝王封禅之地。传说泰山老奶奶（碧霞元君）是泰山的主神，掌管人间生死福祸。泰山还有许多著名传说，如泰山石敢当、泰山挑夫等。这些传说反映了古代人民对自然的敬畏和对美好生活的向往。', '泰安', '["泰山", "泰安", "神话传说"]', 'published', 'ai');
...
INSERT INTO cultural_item (category, title, summary, content, region, tags, status, source) VALUES ('literature', '运河传说', '关于京杭大运河的民间传说，反映运河沿岸人民的生活。', '运河流传说是关于京杭大运河的民间传说。聊城是运河沿岸的重要城市，流传着许多与运河有关的传说。这些传说反映了运河沿岸人民的生活、劳动和爱情，展现了运河文化的丰富内涵。著名的传说包括运河龙王、运河纤夫、运河商帮等。', '聊城', '["运河", "聊城", "生活传说"]', 'published', 'ai');
...
INSERT INTO cultural_item (category, title, summary, content, region, tags, status, source) VALUES ('literature', '黄河号子', '黄河沿岸劳动人民在劳动中创作的民歌，节奏铿锵有力。', '黄河号子是黄河沿岸劳动人民在劳动中创作的民歌。在黄河航运、筑堤、抢险等劳动中，人们为了统一节奏、鼓舞士气，创作了各种号子。黄河号子节奏铿锵有力，歌词朴实生动，反映了黄河人民的勤劳勇敢和乐观精神。著名的有黄河船工号子、黄河夯歌等。', '东营', '["黄河", "东营", "劳动号子"]', 'published', 'ai');
...
INSERT INTO cultural_item (category, title, summary, content, region, tags, status, source) VALUES ('literature', '孔融让梨', '孔子后裔孔融幼时让梨的故事，体现礼让美德。', '孔融让梨是孔子后裔孔融幼时的故事。孔融四岁时，与兄弟们一起吃梨，他每次都拿最小的。大人问他为什么，他说：''我年纪小，应该吃小的，大的留给哥哥们。''这个故事体现了中华民族礼让的传统美德，成为教育儿童的经典故事。孔融是孔子的二十世孙，山东曲阜人。', '济宁', '["孔子", "济宁", "美德故事"]', 'published', 'ai');
