...
INSERT INTO cultural_item (category, title, summary, content, region, tags, status, source) VALUES ('food_opera', '鲁菜', '中国八大菜系之首，以咸鲜为主，注重火候，讲究原汁原味。', '鲁菜是中国八大菜系之首，也是历史最悠久、技法最丰富的菜系。鲁菜以咸鲜为主，注重火候，讲究原汁原味。鲁菜选料精细，刀工精湛，烹调方法多样，擅长爆、炒、烧、塌、焖等技法。鲁菜分为济南菜、胶东菜、孔府菜三大流派，各具特色。', '济南', '["八大菜系", "济南", "传统美食"]', 'draft', 'ai');
...
INSERT INTO cultural_item (category, title, summary, content, region, tags, status, source) VALUES ('food_opera', '德州扒鸡', '德州三宝之一，以五香脱骨、肉嫩味纯著称。', '德州扒鸡是德州三宝之一，以五香脱骨、肉嫩味纯著称。德州扒鸡始于明代，至今已有300多年历史。制作工艺独特，需经过宰杀、整形、油炸、卤煮等多道工序。成品色泽金黄，肉质鲜嫩，骨酥肉烂，香气扑鼻。', '德州', '["德州", "传统美食", "中华老字号"]', 'draft', 'ai');
...
INSERT INTO cultural_item (category, title, summary, content, region, tags, status, source) VALUES ('food_opera', '周村烧饼', '淄博周村传统名点，以薄、香、酥、脆著称。', '周村烧饼是淄博周村传统名点，以薄、香、酥、脆著称。周村烧饼起源于汉代，至今已有1800多年历史。制作工艺独特，需经过和面、揉剂、成型、烘烤等多道工序。成品薄如纸，酥如雪，香如兰，口感酥脆，回味无穷。', '淄博', '["淄博", "传统美食", "中华老字号"]', 'draft', 'ai');
...
INSERT INTO cultural_item (category, title, summary, content, region, tags, status, source) VALUES ('food_opera', '煎饼卷大葱', '山东传统主食，以杂粮煎饼卷大葱、蘸酱食用。', '煎饼卷大葱是山东传统主食，以杂粮煎饼卷大葱、蘸酱食用。山东煎饼历史悠久，相传孟姜女哭长城时带的就是煎饼。煎饼以小米、玉米、高粱等杂粮为原料，摊制而成。食用时卷上大葱、蘸上酱料，简单美味，营养丰富。', '临沂', '["临沂", "传统美食", "地方小吃"]', 'draft', 'ai');
...
INSERT INTO cultural_item (category, title, summary, content, region, tags, status, source) VALUES ('food_opera', '山东快书', '山东省传统曲艺形式，以节奏明快、语言幽默著称。', '山东快书是山东省传统曲艺形式，以节奏明快、语言幽默著称。山东快书起源于清代，由民间说唱艺术发展而来。表演者手持竹板，边打边说，节奏明快，语言生动。代表曲目有《武松传》《鲁达除霸》等。', '济南', '["济南", "传统曲艺", "国家级非遗"]', 'draft', 'ai');
