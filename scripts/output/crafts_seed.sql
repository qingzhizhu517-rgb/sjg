...
INSERT INTO cultural_item (category, title, summary, content, region, tags, status, source) VALUES ('craft', '东昌葫芦雕刻', '省级非物质文化遗产，在葫芦上雕刻各种图案和文字的传统技艺。', '东昌葫芦雕刻是山东省省级非物质文化遗产。聊城东昌府区是著名的葫芦之乡，葫芦雕刻技艺历史悠久。艺人们在葫芦上雕刻各种图案和文字，题材包括花鸟鱼虫、人物故事、山水风景等。雕刻技法有浮雕、透雕、线刻等多种，作品精美绝伦，具有很高的艺术价值。', '聊城', '["省级非遗", "聊城", "传统技艺"]', 'draft', 'ai');
...
INSERT INTO cultural_item (category, title, summary, content, region, tags, status, source) VALUES ('craft', '鲁绣', '国家级非物质文化遗产，山东地区的传统刺绣技艺。', '鲁绣是国家级非物质文化遗产，是山东地区的传统刺绣技艺。鲁绣历史悠久，早在春秋时期就已经出现。鲁绣以丝线、棉线为材料，在绸缎、棉布上绣制各种图案。鲁绣针法丰富，有齐针、套针、抢针、乱针等数十种。题材以花鸟、山水、人物为主，色彩鲜明，构图饱满，具有浓郁的地方特色。', '济南', '["国家级非遗", "济南", "传统美术"]', 'draft', 'ai');
...
INSERT INTO cultural_item (category, title, summary, content, region, tags, status, source) VALUES ('craft', '杨家埠木版年画', '国家级非物质文化遗产，与天津杨柳青、苏州桃花坞年画齐名。', '杨家埠木版年画是国家级非物质文化遗产，与天津杨柳青、苏州桃花坞年画并称中国三大木版年画。杨家埠年画起源于明代，至今已有500多年历史。年画内容以门神、灶王、财神等民俗题材为主，也有历史故事、戏曲人物等。制作工艺包括画稿、刻版、印刷、彩绘等步骤。', '潍坊', '["国家级非遗", "潍坊", "传统美术"]', 'draft', 'ai');
...
INSERT INTO cultural_item (category, title, summary, content, region, tags, status, source) VALUES ('craft', '济南皮影戏', '省级非物质文化遗产，用兽皮雕镂成人物剪影进行表演的传统艺术。', '济南皮影戏是山东省省级非物质文化遗产。皮影戏是用兽皮雕镂成人物剪影，借助灯光在幕布后表演的传统艺术形式。济南皮影戏历史悠久，清代就已经盛行。皮影人物造型精美，色彩鲜艳，表演时配以唱词和乐器伴奏，深受群众喜爱。', '济南', '["省级非遗", "济南", "传统戏剧"]', 'draft', 'ai');
